...
# Plot solution 
plt = plot(times, perfectData, dpi = 400, legend = :topright, labels = "Perfect Incidence Data", xlabel = L"t", ylabel = "Incidence", guidefontfamily = "Computer Modern")
plot!(times, noisyData, labels = "Noisy Incidence Data")
display(plt)
savefig(plt, "perfectIncidenceNoisyIncidence.png")
...
p1 = [8.433316141965086e-5, 0.0012226039846851054, 0.117740857430179]
# p1 = [2., 2., 2.]
...
plt1 = plot(times, sol1, legend=:topright, labels = "Fitted Parameters", xlabel = L"t", dpi = 400)
...
# beta_h (local)
theta1, sol1 = ProfileLikelihood.PL(1e-7, 2000, 1, paramsFitted, [noisyData], [], threshold + 3, loss, prob, solver_opts, times, fitter_opts_PL, [obj]; incidenceObserved = [5])
sol1 = sol1 .+ PLconst 
...
# theta11, sol11 = ProfileLikelihood.PL(2e-5, 1, 1, paramsFitted, [noisyData], [], threshold + 3, loss, prob, solver_opts, times, fitter_opts_PL, [obj]; incidenceObserved = [5], status = "global")
# sol11 = sol11 .+ PLconst 
...
# beta_v (global)
theta2, sol2 = ProfileLikelihood.PL(2.27e-5, 150, 2, paramsFitted, [noisyData], [], threshold + 3, loss, prob, solver_opts, times, fitter_opts_PL, [obj]; incidenceObserved = [5], status = "global")
sol2 = sol2 .+ PLconst 
...
# gamma
theta3, sol3 = ProfileLikelihood.PL(8.333e-3, 150, 3, paramsFitted, [noisyData], [], threshold + 3, loss, prob, solver_opts, times, fitter_opts_PL, [obj]; incidenceObserved = [5], status = "global")
sol3 = sol3 .+ PLconst 
...
# jldsave("sisIncidencePoisson0_45.jld2"; loss, paramsFitted, threshold, thresholdP, PLconst, theta1, sol1, theta2, sol2, theta3, sol3)