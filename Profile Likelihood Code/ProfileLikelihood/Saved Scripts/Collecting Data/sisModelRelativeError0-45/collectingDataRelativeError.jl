...
# Objective function 
obj = (data, sol) -> ProfileLikelihood.relativeError(data, sol, 0.15)
...
# 1002:1130
for seed in 1:100
    perfectData, noisyData = ProfileLikelihood.generateData(5, seed, i -> truncated(Normal(i, 0.15 * i), lower = -eps(Float64)), prob, times, solver_opts; incidenceStatus = true)
...
jldsave("collectionData0_45_relativeError.jld2"; bbLossArr, bbParamsArr, trueLossArr)
