...
Parameternew = EstiParam(23,:);
[t,y_estnew]=ode45(@SIR_model_states,daily,init_cond,[],Parameternew);
...
% plot(t, y_estnew(:,5))
%% MC Optimization
parameter1 = linspace(0.005, 0.0074, 25);
parameter2 = linspace(0.0075, 0.4, 25);
...
err_in_data_SIR(Parameters(2:12),Prevalencedatac, Prevalencedataa, T, Parameters(1))
